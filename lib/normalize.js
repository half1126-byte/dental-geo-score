...
const PLATFORM_DOMAINS = new Set([
  ...
  // 의료 예약·비대면진료 플랫폼 — AI 답변에 출처로 자주 등장하지만 병원 자체 사이트가
  // 아니므로 측정 입력·구조 비교 대상 둘 다에서 제외 (my-doctor.io 심층비교 오탐 사례)
  'my-doctor.io', 'goodoc.co.kr', 'ddocdoc.com', 'modoodoc.com',
  'gangnamunni.com', 'babitalk.com',
  'google.com', 'wikipedia.org', 'namu.wiki',
]);
