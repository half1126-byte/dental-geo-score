...
export function buildClaudeRequest({ system, user }, loc = {}) {
  return {
    ...
    ...(system ? { system } : {}),
    messages: [{ role: 'user', content: user }],
    // web_search_20260209: dynamic filtering (GA 2026-02-09, confirmed Anthropic docs).
    // Upgraded from _20250305; also available: _20260318. Both are real, not hallucinated.
    tools: [{
